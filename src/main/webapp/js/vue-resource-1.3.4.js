...
!(function (t, e) {
  ...
  function y(t, e, n) {
    return (
      (n = n || {}),
      f(n) && (n = n.call(e)),
      b(t.bind({ $vm: e, $options: n }), t, { $options: n })
    );
  }
  function v(t, e) {
    var n, o;
  ...
  function b(t) {
    return (
      V.call(arguments, 1).forEach(function (e) {
        T(t, e, !0);
      }),
      t
    );
        ...
        return t.replace(/\{([^\{\}]+)\}|([^\{\}]+)/g, function (t, r, i) {
          if (r) {
            var u = null,
              s = [];
            if (
              (-1 !== e.indexOf(r.charAt(0)) &&
                ((u = r.charAt(0)), (r = r.substr(1))),
    ...
    if (O(r) && "" !== r)
      if ("string" == typeof r || "number" == typeof r || "boolean" == typeof r)
        ...
        Array.isArray(r)
          ...
          : Object.keys(r).forEach(function (t) {
              O(r[t]) &&
                (u.push(encodeURIComponent(t)), u.push(C(e, r[t].toString())));
            }),
          P(e)
            ? i.push(encodeURIComponent(n) + "=" + u.join(","))
            : 0 !== u.length && i.push(u.join(","));
      }
    else
      ";" === e
  ...
  function N(t, e) {
    ...
    switch (e.length) {
      ...
      default:
        throw (
          "Expected up to 2 arguments [params, body], got " +
          e.length +
          " arguments"
        );
    }
      ...
      r(function () {
        if (t.state !== J)
          for (; t.deferred.length; ) {
            ...
            try {
              0 === t.state
                ? r("function" == typeof n ? n.call(void 0, t.value) : t.value)
                : 1 === t.state &&
                  ("function" == typeof o
                    ? r(o.call(void 0, t.value))
                    : i(t.value));
            } catch (t) {
              i(t);
            }
  ...
  var F,
    ...
    Z = function (t, e) {
      var n = e(t);
      return (
        c(t.root) && !/^(https?:)?\//.test(n) && (n = u(t.root, "/") + "/" + n),
        n
      );
    },
    tt = function (t, e) {
  ...
  (U.options = { url: "", root: null, params: {} }),
    (U.transform = { template: et, query: tt, root: Z }),
    ...
    rt = function (t, e) {
      if (z) {
        var n = U.parse(location.href),
          o = U.parse(t.getUrl());
        (o.protocol === n.protocol && o.host === n.host) ||
          ((t.crossOrigin = !0), (t.emulateHTTP = !1), ot || (t.client = nt));
      }
      e();
    },
    it = function (t, e) {
        ...
        e(function (t) {
          return t.bodyText
            ? m(t.text(), function (e) {
                if (
                  0 ===
                    (n = t.headers.get("Content-Type") || "").indexOf(
                      "application/json"
                    ) ||
                  S(e)
                )
    ...
    st = function (t) {
      return new e(function (e) {
        var n,
          ...
          r = t.jsonp || "callback",
          i =
            t.jsonpCallback || "_jsonp" + Math.random().toString(36).substr(2),
          u = null;
        (n = function (n) {
          var r = n.type,
            s = 0;
    ...
    dt = function (t) {
      ...
      return new e(function (e) {
        ...
        t.headers.forEach(function (t, e) {
          ...
          n(r, { body: u, method: s, headers: a }).then(
            (o = function (n) {
  ...
  var yt = function (t, e) {
    ...
    (this.url = n),
      ...
      c(t)
        ? (this.bodyText = t)
        : d(t) && ((this.bodyBlob = t), L(t) && (this.bodyText = H(t)));
  };
  ...
  var vt = function (t) {
    (this.body = null),
      (this.params = {}),
      Y(this, t, { method: a(t.method || "GET") }),
  ...
  var bt = { Accept: "application/json, text/plain, */*" },
    gt = { "Content-Type": "application/json;charset=utf-8" };
  return (
    (B.options = {}),
    (B.headers = {
      put: gt,
